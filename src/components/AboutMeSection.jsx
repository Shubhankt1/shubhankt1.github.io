        ...
        >
          ...
          <div className="space-y-6">
            ...
            <p className="section-text">
              ...
              watching football (and obsessing over Cristiano Ronaldo{" "}
              <sup>7</sup>), or watching the one show I like the 100
              <sup>th</sup> time. Let's build something amazing together.
            </p>
          </div>
        </div>
      </div>
